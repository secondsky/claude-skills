...
/**
 * Take a screenshot
 * Usage: bun screenshot.js --output screenshot.png [--url https://example.com] [--full-page true] [--selector .element] [--max-size 5] [--no-compress]
 * Supports both CSS and XPath selectors:
 *   - CSS: bun screenshot.js --selector ".main-content" --output page.png
 *   - XPath: bun screenshot.js --selector "//div[@class='main-content']" --output page.png
 */
