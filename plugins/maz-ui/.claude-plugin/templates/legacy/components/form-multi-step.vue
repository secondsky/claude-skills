...
import { pipe, string, email, minLength, number, minValue } from 'valibot'
...
// Step 3 schema (review - no validation needed)
const step3Schema = {}
...
const canProceed = computed(() => {
  if (currentStep.value === 1) {
    return !Object.values(step1.errors.value).some(Boolean)
  }
  if (currentStep.value === 2) {
    return !Object.values(step2.errors.value).some(Boolean)
  }
  return true
})
