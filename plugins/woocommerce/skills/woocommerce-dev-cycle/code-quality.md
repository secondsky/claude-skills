...
```bash
# Install markdownlint (prefer bun for global installs)
bun install -g markdownlint-cli
...
3. **Run linting checks** (current step)
4. **Fix code quality issues** (current step)
