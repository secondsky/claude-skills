...
# Replace PROJECT_NAME_PLACEHOLDER
sed -i '' "s/PROJECT_NAME_PLACEHOLDER/$PROJECT_NAME/g" wrangler.toml 2>/dev/null || sed -i "s/PROJECT_NAME_PLACEHOLDER/$PROJECT_NAME/g" wrangler.toml
