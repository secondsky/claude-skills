...
## APPROACH FOR MEDIUM SKILLS

Skills in this range (800-1,500 lines) typically need:
- Extract 1-2 reference files (not full catalog like Phase 2)
- Create 2-3 templates
- Keep SKILL.md focused on getting started
- Less reorganization than large skills

**Time per skill**: 40-50 minutes average
