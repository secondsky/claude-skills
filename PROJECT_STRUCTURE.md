...
├── plugins/                 # 139 plugin directories containing 180 skills
...
**Purpose**: Defines 139 plugins containing 180 skills for Claude Code's plugin marketplace.
...
**139 plugins** organizing **180 individual skills** by domain.
...
- api-security-hardening, csrf-protection
...
##### **Content Management** (1 plugin, 1 skill)
- hugo
...
- `baseline-audit-all.sh` - Validate all 180 skills
...
**JavaScript Dependencies**: ai, openai, anthropic, google, workers-ai-provider, zod, react, react-dom, next, tailwindcss, vite, eslint, puppeteer, vitest, workers-types, wrangler, hono, cloudflare, drizzle-orm, drizzle-kit, playwright, bun, react-hook-form, react-query, react-router, react-table, genui-sdk, postcss, autoprefixer

**Python Dependencies**: httpx, python-dotenv, pydantic, openai, fastapi, uvicorn, flask, flask-cors
...
3. `plugins/tanstack-query/.../examples/react-native` (2 importers)
...
### 180 Skills (Individual Capabilities)
...
Plugin: "cloudflare-workers" (1 of 139)
  ↓ contains
